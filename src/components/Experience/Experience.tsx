...
const ExperienceSubpage = ({
	...
	return (
		<ExperienceGridText>
			...
			<ExperienceText>{children}</ExperienceText>
		</ExperienceGridText>
	);
};
	...
	return (
		<ExperienceContents title="競技プログラミング">
			<ExperienceText>
				...
				現在のレーティングは<SpanColor color="#00C0C0">水色</SpanColor>
				（登録者のうち上位15%に当たる）です。
			...
			<ExperienceGrid>
				<ExperienceGridImage>
					<Image
						src="/images/experience/atcoder-rating-transition-graph-cyan.png"
						alt="AtCoderのレート遷移"
						fill
				...
				<ExperienceGridImage>
					<Image
						src="/images/experience/atcoder-rating-hist-cyan.png"
						alt="AtCoderのレート遷移"
						fill
						style={{ borderRadius: "20px", objectFit: "contain" }}
					/>
			...
			<ExperienceGrid ratio={[3, 4]}>
				...
				<ExperienceGridImage>
					<Image
						src="/images/experience/binary_search_rust_wide.png"
						alt="Rustでの二分探索"
						fill
	...
	return (
		<ExperienceContents title="Web関係">
			<ExperienceGrid ratio={[2, 3]}>
				...
				<ExperienceGridImage>
					<Image
						src="/images/experience/github_about.png"
						alt="GitHub"
						fill
						style={{ borderRadius: "20px", objectFit: "cover" }}
					/>
			...
			<ExperienceGrid ratio={[2, 3]}>
				...
				<ExperienceGridImage>
					<Image
						src="/images/experience/nuocw_about.png"
						alt="NUOCW"
						fill
						style={{ borderRadius: "20px", objectFit: "cover" }}
					/>
			...
			<ExperienceGrid ratio={[2, 3]}>
				...
				<ExperienceGridImage>
					<Image
						src="/images/experience/powell_blog.png"
						alt="NUOCW"
						fill
						style={{ borderRadius: "20px", objectFit: "cover" }}
					/>
			...
			<ExperienceZemiGrid>
				<ExperienceOptimizeText>
					<ExperienceSubpage title="パラメータの最適化">
						「ゼロから作るディープラーニング」という書籍を輪読し、実際に AI
						を作ってみるというテーマのゼミでの発表です。
						ニューラルネットワークにおけるパラメータとは何かというレベルから、いかにして様々なパラメータを最適になるように調整していくかという内容まで、段階的に説明しました。
					</ExperienceSubpage>
				</ExperienceOptimizeText>
				<ExperienceOptimizeImage>
					<Image
						src="/images/experience/parameter_optimization.png"
						alt="パラメータの最適化"
						fill
				...
				<ExperienceKeisanryoImage>
					<Image
						src="/images/experience/keisanryo.png"
						alt="計算量"
						fill
						style={{ borderRadius: "10px", objectFit: "cover" }}
					/>
